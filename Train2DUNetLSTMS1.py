...
from src.datatools import data_weight_sampler, ReadData_V6, ReadData_V7, ReadData_S1
from src.model_config import train_val, EarlyStopping
...
def train(cultivar_list = None, patch_size = 80, patch_offset = 40, dropout = 0.3, batch_size = 64, learning_rate = 0.0001, 
                        weight_decay = 0.0006, loss_stop_tolerance = 100, epochs = None, spatial_resolution = None, exp_name = None):


    #==============================================================================================================#
    #================================================== Root Directories  =========================================#
    #==============================================================================================================#
    # directory for raw data from data2 
    ...
    # creating the directory for saving all the outputs files for each experiment training run: 
    ...
    if not isExist:
        ...
        os.mkdir(exp_output_dir + '/RVs')
        os.mkdir(exp_output_dir + '/loss')
    ...
    #==============================================================================================================#
    #================================================== csv file generator=========================================#
    train_csv, val_csv, test_csv = utils.scenario_csv_generator(scenario = 1, spatial_resolution = spatial_resolution, 
    ...
    for epoch in range(1, epochs+1):
        ...
        for batch, sample in enumerate(data_loader_training):
            ...
            list_y_train_pred  = model(X_train_batch)
        ...
        with torch.no_grad():
            ...
            for batch, sample in enumerate(data_loader_validate):
                ...
                list_y_val_pred   = model(X_val_batch)
...
if __name__ == "__main__":
    train(cultivar_list = None, patch_size = 80, patch_offset = 40, 
        dropout = 0.3, batch_size = 32, learning_rate = 0.0001, 
        weight_decay = 0.01, loss_stop_tolerance = 200,
        epochs = 500, spatial_resolution = 1, exp_name = 'S1_UNetLSTM_1m_time')
